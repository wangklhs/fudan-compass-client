      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="第1节">
            <el-input v-model="form.courses[0]" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="第2节">
            <el-input v-model="form.courses[1]" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="第3节">
            <el-input v-model="form.courses[2]" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="第4节">
            <el-input v-model="form.courses[3]" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="第5节">
            <el-input v-model="form.courses[4]" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="第6节">
            <el-input v-model="form.courses[5]" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="第7节">
            <el-input v-model="form.courses[6]" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="第8节">
            <el-input v-model="form.courses[7]" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="第9节">
            <el-input v-model="form.courses[8]" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="第10节">
            <el-input v-model="form.courses[9]" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="第11节">
            <el-input v-model="form.courses[10]" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="第12节">
            <el-input v-model="form.courses[11]" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="第13节">
            <el-input v-model="form.courses[12]" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="第14节">
            <el-input v-model="form.courses[13]" />
          </el-form-item>
        </el-col>
      </el-row>

      <el-form-item style="text-align: right">
        <el-button type="success" @click="submitForm('form')" style="width: 150px; background-color: #575757">确认</el-button>
      </el-form-item>
    </el-form>
  </el-dialog>
</template>
